...
I'm really passionate about cars, so this gave me an opportunity to work on making an ecosystem for something I love!
...
I've included my application.properties for the Spring Boot backend (it doesn't contain anything bad!) but not my Spring .env file (located in src/main/client directory) for front-end that contains:
...
Besides that, you should be able to clone the repository, start Spring, start the DB server, run npm install, and npm run dev.
